...
// https://github.com/bneukom/gpu-nbody/blob/master/kernels/nbody/calculateforce.cl
// Main changes made:
// Combined integration and calculation parts into one kernel
// Float3 type used for more compact calculations
